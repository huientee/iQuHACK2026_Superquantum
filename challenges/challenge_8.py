...
def main():
    ...
    with open("../circuits/challenge_8_real.qasm", "w") as f:
        f.write(qasm_baseline)
    print("  Saved: challenge_8_real.qasm")
    ...
    with open("../circuits/challenge_8_synth.qasm", "w") as f:
        f.write(qasm_optimized)
    print("Saved: challenge_8_synth.qasm")
