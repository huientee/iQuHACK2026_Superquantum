...
def main():
    ...
    with open("../circuits/challenge_2_m.qasm", "w") as f:
        f.write(qasm_baseline)
    print("  Saved: challenge_2_m.qasm")
    ...
    with open("../circuits/challenge_2_m_synth.qasm", "w") as f:
        f.write(qasm_optimized)
    print("Saved: challenge_2_m_synth.qasm")
